	...
	<div style="width: 450px">
		<form action="#" name="member" method="get">
			<fieldset>
				...
				<p>
					<label>성 별 : </label> <input type="radio" id="sel_m" name="sex"
						value="남성" checked><label for="sel_m">남성</label> <input
						type="radio" id="sel_g" name="sex" value="여성"><label
						for="sel_g">여성</label>
				</p>
				<p>
					<label>취 미 : </label> <label for="h1">독서</label><input
						type="checkbox" id="h1" name="hobby1" checked> <label
						for="h2">운동</label><input type="checkbox" id="h2" name="hobby2">
					<label for="h3">영화</label><input type="checkbox" id="h3"
						name="hobby3">
				</p>
				<p>
